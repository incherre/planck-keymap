...
[_RAISE] = LAYOUT_ortho_4x12(
    ...
    KC_LEFT, KC_HOME,  KC_PGDN, KC_PGUP,         KC_END,  DM_REC1, DM_PLY1, KC_LEFT, KC_DOWN,        KC_UP,   KC_RGHT, KC_RGHT,
    KC_VOLD, KC_VOLU,  KC_LGUI, LALT_T(KC_BSPC), KC_LSFT, KC_ENT,  XXXXXXX, KC_SPC,  RCTL_T(KC_DEL), DM_RSTP, DM_REC2, DM_PLY2
)
